...
def test_classifer(dataset, classifier_cls, dist_func=distance.euclidean, dist_func_params=None):
    print("="*80)
    print("\n")
...
if __name__ == '__main__':
    test_classifer("Beef", KNeighborsClassifier, dist_func=distance.dtw_win, dist_func_params={'win': 100})
