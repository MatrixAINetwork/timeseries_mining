...
class KNeighborsClassifierVariousDim:
    """

    """

    def __init__(self, n_neighbors=5,
                 distfunc=distance.dist_basic_dtw, distfunc_params=None,
    ...
    def predict(self, X):
        ...
        for ind, iX in enumerate(X):
            dist_list = []
            for iTrain in self._fit_X:
                dist = self.distfunc(iX, iTrain, **self.effective_distfunc_params_)
