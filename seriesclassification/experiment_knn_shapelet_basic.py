...
from tsmining.tools import output
...
filedir_result = os.path.join(OUT_ROOT, str_param_reduced+tail+'.md')
dir_shapelet = os.path.join(OUT_ROOT, str_param_reduced+tail)
...
for item in dataset:
    ...
    acc, best_shapelets = pipline_shapelet.run(name,
